...
func newOrganization(ctx *clientContext, apiObj *Group, ref gitprovider.OrganizationRef) *organization {
	return &organization{
		clientContext: ctx,
		g:             *apiObj,
		ref:           ref,
...
func organizationFromAPI(apiObj *Group) gitprovider.OrganizationInfo {
